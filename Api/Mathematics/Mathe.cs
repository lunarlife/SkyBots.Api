...
public static class Mathe
{
    ...
    public static bool TryClamp<T>(Vector3<T> value, Vector3<T> min, Vector3<T> max) where T : INumber<T> => Clamp(value, min, max) == value;
    public static bool TryClamp<T>(Vector2<T> value, Vector2<T> min, Vector2<T> max) where T : INumber<T> => Clamp(value, min, max) == value;
